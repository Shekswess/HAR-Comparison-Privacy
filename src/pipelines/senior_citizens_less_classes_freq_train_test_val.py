...
if __name__ == "__main__":
    path = r"D:\Work\HAR-Comparison-Privacy\processed_data\activity_recognition_senior_citizens_less_classes_frequency_features\all_users.csv"
    base_figure_path = (
        r"..\figures\senior_citizens_less_classes_frequency_features_80_20"
    )
    ...
    label_column = "Label"
    labels = {1: "Walking", 2: "Shuffling", 3: "Stairs", 4: "Still"}
    create_experiment("senior_citizens_less_classes_frequency_features_80_20")
    set_experiment("senior_citizens_less_classes_frequency_features_80_20")
