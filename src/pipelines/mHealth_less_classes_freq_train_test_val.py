...
if __name__ == "__main__":
    path = r"D:\Work\HAR-Comparison-Privacy\processed_data\activity_recognition_mHealth_less_classes_frequency_features\all_users.csv"
    base_figure_path = r"..\figures\mHealth_less_classes_frequency_features_80_20"
