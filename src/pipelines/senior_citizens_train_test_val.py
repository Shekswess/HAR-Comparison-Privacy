...
if __name__ == "__main__":
    path = r"D:\Work\HAR-Comparison-Privacy\processed_data\activity_recognition_senior_citizens\all_users.csv"
    base_figure_path = r"..\figures\senior_citizens_80_20"
