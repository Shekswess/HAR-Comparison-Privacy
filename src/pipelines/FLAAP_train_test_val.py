...
if __name__ == "__main__":
    path = r"D:\Work\HAR-Comparison-Privacy\processed_data\activity_recognition_FLAAP\all_users.csv"
    base_figure_path = r"..\figures\FLAAP_80_20"
    ...
    create_experiment("FLAAP_80_20")
    set_experiment("FLAAP_80_20")
